    ...
    <ManagerLayout>
      <div className="flex flex-col items-center justify-center py-20 text-center">
        <div className="w-14 h-14 rounded-full bg-[#EEF2FF] flex items-center justify-center mb-4">
          <Award className="w-7 h-7 text-[#3B5BFF]" />
        </div>
        <h1 className="text-xl font-bold text-[#111827] mb-2">Leadership</h1>
        <p className="text-[13px] text-[#6b7280] max-w-md">
          Coming Soon — This page will provide leadership development resources, PRISM-based leadership style analysis, and coaching recommendations for managers.
        </p>
