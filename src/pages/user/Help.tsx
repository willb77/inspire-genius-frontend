  ...
  return (
    <UserLayout>
      <div className="space-y-4">
        ...
        {/* Live assistant. Was a VoiceDeskAI iframe behind
            VITE_VOICEDESK_ENABLED, which left the button inert on any build
            without that flag; now opens the in-app Meridian assistant. */}
        <div className="rounded-2xl border border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50 p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-base font-semibold tracking-tight">Talk to Meridian</h2>
            <p className="text-sm text-muted-foreground mt-0.5">
              Ask a question by voice or text and get an answer right away. Need a
              person? Submit a request above and a human will pick it up.
            </p>
          </div>
          <Button variant="default" className="shrink-0" onClick={openSupportAgent}>
            Speak with Support
          </Button>
        </div>
