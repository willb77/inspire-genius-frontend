...
/**
 * DocumentsV2 — the new-design ("HomeV2" system) variant of Documents. Flag-gated
 * (new_user_surfaces) additive swap; the classic page is unchanged and remains
 * at /documents/classic. Same data/hooks/logic — only the presentation is
 * re-skinned to the cream panel + tokens + serif heading. RTL-safe (logical CSS).
 */
      ...
      <V2Panel>
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex flex-col items-end gap-2" data-tour="docs-toolbar">
            <Button
              className="h-9 px-4 bg-ink text-white hover:bg-ink/90"
            ...
            <div className="flex items-center gap-3 justify-end">
              ...
              <IconInput
                ...
                className="rounded-xl bg-white border border-hairline w-[300px] md:w-[320px]"
              />
        ...
        <div className="flex items-center gap-3 mt-10">
          ...
          {selectedCount > 0 ? (
            <span className="text-accent-orange-dark bg-accent-orange/15 rounded-lg px-3 py-1 text-sm font-medium">
        ...
        {/* Sections */}
        <V2Card className="p-4" data-tour="docs-sections">
          {listLoading && (
                ...
                <div key={i}>
                  ...
                  <div className="space-y-2">
                    {[0, 1, 2].map((j) => (
                      <div
                        key={j}
                        className="flex items-center justify-between gap-3 rounded-xl border border-hairline bg-white px-3 py-2"
                      >
          ...
          {!listLoading && sections.length === 0 && (
            <div className="py-16 grid place-items-center text-center">
              ...
              <div className="text-sm text-body-slate mb-4">
          ...
          {!listLoading && sections.length > 0 &&
            sections.map((sec, idx) => (
              <div key={sec.title} className={idx > 0 ? "mt-6" : undefined}>
                <button
                  type="button"
                  className="flex items-center gap-2 text-sm text-body-slate"
                ...
                {!collapsed[sec.title] && (
                  <div className="mt-2 space-y-2">
                    {sec.items.map((d: UIDocItem) => (
                      <div
                        key={d.id}
                        className="w-full flex items-center justify-between gap-3 rounded-xl border border-hairline bg-white px-3 py-2"
                      >
                        ...
                        {d.categoryName ? (
                          <p className="flex-1 text-center text-xs text-body-slate">
                            {d.categoryName}
                          </p>
                        ) : null}
                        <div className="flex items-center gap-3">
                            ...
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <button
                                  ...
                                  className="cursor-pointer text-body-slate hover:text-amber-500"
                          ...
                          <button
                            title="Download"
                            className="cursor-pointer text-body-slate hover:text-ink"
