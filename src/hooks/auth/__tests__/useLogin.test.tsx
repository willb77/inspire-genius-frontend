...
describe("useAuthLoginMutation", () => {
  ...
  test("successfully logs in and returns data along with credentials", async () => {
    ...
    const credentials = {
      ...
      password: process.env.TEST_VALID_PASSWORD as string,
    };
  ...
  test("accepts and calls custom onSuccess callback", async () => {
    ...
    expect(onSuccessMock).toHaveBeenCalledWith(
      ...
      { email: "user@test.com", password: process.env.TEST_VALID_PASSWORD as string },
      undefined
    );
  ...
  test("calls custom onError callback when API rejects", async () => {
    ...
    expect(onErrorMock).toHaveBeenCalledWith(
      mockError,
      { email: "fail@test.com", password: process.env.TEST_VALID_PASSWORD as string },
      undefined
    );
