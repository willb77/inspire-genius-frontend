  ...
  return (
    <div
      ...
      className={cn(
        ...
        "relative flex h-14 w-14 items-center justify-center rounded-xl border border-input bg-transparent text-lg shadow-xs transition-all outline-none data-[active=true]:z-10 data-[active=true]:ring-[3px]",
        className
      )}
      {...props}
    >
