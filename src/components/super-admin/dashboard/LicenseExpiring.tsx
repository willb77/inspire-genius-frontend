            ...
            <Card className="lg:col-span-1 w-full p-4 shadow-none border-none">
              <div className="flex items-center justify-between">
                ...
                <div className="flex flex-col text-left">
                  <p className="text-sm text-gray-600">{item.organization_name}</p>
                  <p className="text-lg font-medium">{item.days_until_expiry} days remaining</p>
                </div>

                {/* Right side */}
                <div className="text-right">
                  <div className="text-xs text-gray-500">{item.subscription_tier}</div>
