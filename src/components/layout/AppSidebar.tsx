...
import { getSectionsForRole, grantSidebarSectionForRole, BROADCAST_SIDEBAR_SECTION, KCE_SIDEBAR_SECTION, type SidebarNavItem } from "@/constants/sidebar-sections"
...
export default function AppSidebar({ role, open, onClose, collapsed, onToggleCollapse }: AppSidebarProps) {
  ...
  const sections = [
    ...
    ...(hasKceAccess ? [KCE_SIDEBAR_SECTION] : []),
