/**
 * Shared body for the Maven (InterviewAgent) interview prep task agent.
 *
 * Mounted by both /manager/interview-prep and /practitioner/interview-prep
...
export default function InterviewPrepBody() {
